...
const MagisterateSidebar = ({ isDarkMode }) => {
  ...
  const navigationItems = [
    ...
    { name: 'View Case', icon: FileText, path: '/cases' },
    { name: 'View Chargesheet', icon: FileText, path: '/chargesheets' },
  ...
  const stakeholderItems = [
    ...
    { name: 'Advocate Portal', icon: Users, path: '/advocate' },
  ];
...
export default MagisterateSidebar;
